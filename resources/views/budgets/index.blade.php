    ...
    <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-2 mb-3">
                    ...
                    <select name="status" id="status" class="form-select">
                        ...
                        <option value="rejected" {{ ($filters['status'] ?? '') === 'rejected' ? 'selected' : '' }}>Nao aceite</option>
                    </select>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @elseif ($budget->status === 'rejected')
                                        <span class="badge bg-danger">Nao aceite</span>
                                    @else
        ...
        @else
            <div class="text-muted">
                Nao foram encontrados orcamentos com os filtros aplicados.
            </div>
        @endif
    </div>
</div>
