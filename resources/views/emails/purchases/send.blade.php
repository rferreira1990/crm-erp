                                    ...
                                    <td style="padding:28px 32px;">
                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                            <tr>
                                                ...
                                                <td valign="middle">
                                                    <div style="font-size:14px; line-height:20px; font-weight:700; letter-spacing:1.2px; text-transform:uppercase; color:#93c5fd; margin-bottom:6px;">Envio tecnico de RFQ</div>
                                                    <div style="font-size:30px; line-height:36px; font-weight:700; color:#ffffff; margin-bottom:8px;">{{ $companyDisplayName }}</div>
                                                    <div style="font-size:15px; line-height:22px; color:#cbd5e1;">RFQ {{ $purchaseRequest->code }} · Data {{ $rfqDate }}</div>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                <tr>
                                    <td style="padding:34px 32px 24px 32px;">
                                        ...
                                        <div style="font-size:16px; line-height:28px; color:#374151; margin-bottom:22px;">Enviamos em anexo o pedido de cotacao {{ $purchaseRequest->code }} para apresentacao da vossa proposta.</div>

                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-bottom:24px;">
                                            <tr>
                                                <td style="background:#f8fafc; border:1px solid #e2e8f0; border-radius:16px; padding:20px;">
                                                    <div style="font-size:13px; line-height:18px; font-weight:700; text-transform:uppercase; letter-spacing:0.8px; color:#64748b; margin-bottom:14px;">Resumo tecnico do RFQ</div>
                                                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                                        ...
                                                        <tr><td style="font-size:14px; line-height:22px; color:#64748b; padding:4px 0;">Data</td><td align="right" style="font-size:14px; line-height:22px; color:#111827; font-weight:700; padding:4px 0;">{{ $rfqDate }}</td></tr>
                                                        <tr><td style="font-size:14px; line-height:22px; color:#64748b; padding:4px 0;">Prazo para proposta</td><td align="right" style="font-size:14px; line-height:22px; color:#111827; font-weight:700; padding:4px 0;">{{ $deadline }}</td></tr>
                                                        <tr><td style="font-size:14px; line-height:22px; color:#64748b; padding:4px 0;">Numero de linhas</td><td align="right" style="font-size:14px; line-height:22px; color:#111827; font-weight:700; padding:4px 0;">{{ $lineCount }}</td></tr>
                                                    </table>
                                                </td>
                                            </tr>
                                        </table>
