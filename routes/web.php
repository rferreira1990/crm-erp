...
// Entrada da aplicacao: redireciona para o dashboard.
Route::get('/', function () {
    return redirect()->route('dashboard');
});

// Area protegida por autenticacao.
Route::middleware(['auth'])->group(function () {
    // Dashboard principal apos login.
    ...
    // Gestao de orcamentos e respetivos itens/anexos operacionais.
    ...
    // Configuracoes da aplicacao (acesso apenas com settings.manage).
    Route::middleware(['permission:settings.manage'])->group(function () {
        // Perfil da empresa e testes de email.
        ...
        // Catalogos auxiliares de artigos/faturacao.
    ...
    // Gestao de artigos e ficheiros associados.
...
// Rotas de autenticacao (Breeze/Laravel auth scaffolding).
