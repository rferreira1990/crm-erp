...
class UpdateBudgetHeaderRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        $this->merge([
            ...
            'zone' => $this->filled('zone')
                ? trim((string) $this->input('zone'))
                : null,

            'project_name' => $this->filled('project_name')
                ? trim((string) $this->input('project_name'))
                : null,
            ...
            'budget_date' => $this->filled('budget_date')
                ? $this->input('budget_date')
                : now()->toDateString(),
        ]);
    }
